...
public interface AdminMainDao {
	...
	public AdminVO selectAdminInfo(String adminId) throws SQLException;// 관리자의
																		// 정보를
																		// 가져온다.
	...
	public ArrayList<LoaVO> selectUntreatedLoaList() throws SQLException; // 미처리된
																			// 휴학신청정보를
																			// 가져온다.

	public ArrayList<RtsVO> selectUntreatedRtsList() throws SQLException; // 미처리된
																			// 복학신청정보를
																			// 가져온다.

	public ArrayList<PerschdVO> selectPerschdList(String adminId)
			throws SQLException; // 개인일정을 가져온다.

	public ArrayList<Map<String, String>> selectScrapplList()
			throws SQLException; // 미처리된 장학신청정보를 가져온다.
