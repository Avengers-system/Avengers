					...
					<div class="col-xs-12" id="professorContent">
						<div class="row">
							<div class="col-md-2" id="professorLeftSide">
								...
								<input type="button" value="출석부" onclick="location.href='lectureAttend.jsp'">
								...
								<input type="button" value="수강생관리" onclick="location.href='lectureStudent.jsp'">
							...
							<div class="col-md-10" id="professorRightSide">
								...
								수강생 명단과 지각, 출석, 결석, 등 출결에 관한 부분을 관리한다.
								이의신청확인 탭도 있어서 출결을 수정할 수도 있다.
