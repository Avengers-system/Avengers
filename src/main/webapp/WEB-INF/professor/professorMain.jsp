					...
					<div class="col-xs-12" id="professorContent">
						<div class="row">
							<div class="col-md-2" id="professorLeftSide">
								<div class="row">
									<div class="col-xs-12" id="professorLeftSideUp">이름 00대학 00학부 학과장</div>
									<div class="col-xs-12" id="professorLeftSideDown">개인일정 달력</div>
								</div>
							</div>
							<div class="col-md-10" id="professorRightSide">
								<div class="row">
									<div class="col-md-6" id="professorRightTopLeft">강의현황 테이블</div>
									<div class="col-md-6" id="professorRightTopRight">상담현황 테이블</div>
									<div class="col-xs-12" id="professorRightDown">대학교 소식 테이블</div>
								</div>
							</div>
						</div>
					</div>
