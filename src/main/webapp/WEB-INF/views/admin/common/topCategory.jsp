...
<div class="col-md-12" id="commonUserHeader">
	<div class="col-md-10 col-md-offset-1">
			<ul class="nav nav-tabs">
				<li role="presentation"><a href="${pageContext.request.contextPath}/admin/mypage/">My FDFDPage</a></li>
				...
				<li role="presentation"><a href="${pageContext.request.contextPath}/admin/main/helpDeskMain">1HelpDesk</a></li>
			</ul>
	</div>
