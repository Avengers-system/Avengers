								...
								<form action="updateEvent?id=${event.perschd_num}" method="POST">
									<ul>
										<li><input type="hidden" class="form-control"
											name="perschd_num" value="${event.perschd_num}"></li>
										<li><label class='control-label'>title</label> <input
											type="text" class="form-control" name="perschd_title"
											value="${event.perschd_title}"></li>
										<li><label class='control-label'>start date</label> <input
											type="date" name="perschd_start_date"
											value="${event.perschd_start_date}" class="form-control">
										</li>
										<li><label class='control-label'>start date</label> <input
											type="date" name="perschd_writer"
											value="${event.perschd_writer}" class="form-control">
										</li>
										<li><label class='control-label'>end date</label> <input
											type="date" name="perschd_end_date"
											value="${event.perschd_end_date}" class="form-control">
										</li>
										<li><label class='control-label'>content</label> <input
											type="text" name="perschd_cont" value="${event.perschd_cont}"
											class="form-control"></li>
										<li><label class='control-label'>date</label> <input
											type="text" name="perschd_date" value="${event.perschd_date}"
											class="form-control"></li>
