            ...
            <div class="row">
               <div class="content col-md-10" style="font-size: 16px">
                  <form name="tx_editor_form" style="width: 895px;"
                     id="tx_editor_form" action="/admin/portalWriteForm"
...
<%--                                  ${insertBoard.board_date} --%>
                     ...
                     <div class="col-sm-9">
<%--                         <c:if test="${not empty insertBoard }"> --%>
<!--                            <input type="hidden" name="board_writer" -->
<%--                               value="${insertBoard.board_writer }"> --%>
<!--                            <input type="hidden" name="board_bc" -->
<%--                               value="${insertBoard.board_bc }"> --%>
<%--                         </c:if> --%>
<%--                         <input type="hidden" name="board_num" value="${insertBoard.board_num }"> --%>
                     </div>
                     <!-- 에디터 컨테이너 시작 -->
...
<%-- <c:choose> --%>
<%-- <c:when test='${not empty insertBoard}'> --%>
