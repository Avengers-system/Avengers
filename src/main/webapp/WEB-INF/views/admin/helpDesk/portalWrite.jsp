...
value="<%=user.getUsername()%>"><br>
	...
	분류번호:<input type="text" name="board_bc" readonly 

value="PORTAL"><br>
	조회수:<input type="text" name="board_count" readonly 
