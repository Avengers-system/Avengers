								...
								<table id="datatables-example"
									...
									<c:choose>
										<c:when test="${not empty collegeNoticeList}">
											<c:forEach var="collegeNoticeList"
												items="${collegeNoticeList }">
												<tbody>
													<tr role="row" class="odd">
														<td>${collegeNoticeList.board_num}</td>
														<td><a
															href="${pageContext.request.contextPath}/admin/collegeDetail?board_num=${collegeNoticeList.board_num}&board_count=${collegeNoticeList.board_count}&pageNo=${pageVO.pageNo}">
															${collegeNoticeList.board_title}
														</a></td>
														<td>${collegeNoticeList.board_date}</td>
														<td>${collegeNoticeList.board_writer}</td>
														<td>${collegeNoticeList.board_af}</td>
														<td>${collegeNoticeList.board_bc}</td>
														<td>${collegeNoticeList.board_count}</td>
													</tr>
												</tbody>
											</c:forEach>
								</table>
