		...
		<div class="row">
			...
			<div class="col-xs-12" id="content">
				...
				<div class="row">
					...
					<div class="col-md-2" id="adminLeftSide">관리자, 개인일정(캘린더)</div>

					<div class="col-md-10" id="adminRightSide">
						<div class="row">
							<div class="col-xs-12" id="adminRightSideUp">엑셀전송, PDF전송</div>
							<div class="col-xs-12" id="adminRightSideCenter">재학생, 휴학생, 신입생,교수현황</div>
							<div class="col-xs-12" id="adminRightSideDown">학생등록수, 강의등록수, ㅇㅇ등록수</div>
						</div>
					</div>
				</div>
