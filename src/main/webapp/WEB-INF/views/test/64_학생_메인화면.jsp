				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-2">
							<div class="row">
								<div class="col-xs-12">
								학생이름/소속대학/전공/학년/학적상태를 나타낸다.
								</div>
								<div class="col-xs-12">
								년/월로 구성된 셀렉트박스와 캘린더로 구성되어있으며 개인일정을
								관리할수있다.
								</div>
							</div>
						</div>
						<div class="col-md-10">
							<div class="row">
								<div class="col-md-9">
								년도/학기/과목명/분반이 표시되는 수강현황차트와 제목/상담여부가 표시되는 상담현황차트
								</div>
								<div class="col-md-3">
								이수학기/총이수학점/수강신청학점등이 표시되는 학사관련정보
								</div>
								<div class="col-xs-12">
								포털소식/학교공지/학과공지/학사일정으로 이루어져있는 공지사항 차트
								</div>
							</div>
						</div>
					</div>
