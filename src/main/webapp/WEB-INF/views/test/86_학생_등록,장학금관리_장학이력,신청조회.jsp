...
<title>학생-등록/장학금관리-장학이력/신청조회</title>
<!-- css초기화 -->
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-10">
							<div class="row">
								<div class="col-xs-12">
								년도/학기의 셀렉트박스와 대학/전공/학년/평점평균/평균점수/취득학점/학번/이름이 표시된 학생의학사정보차트
								</div>
								<div class="col-xs-12">
								년도/학기/장학금명/장학금/수업료/기타장학/계/은행/계좌번호로 이루어진 검색된 장학이력차트
								</div>
								<div class="col-xs-12">
								년도/학기/장학금명/자격/소득분위/예금주/계좌번호/신청일자로 이루어진 로그인한 학생의 장학금신청내역
								</div>
							</div>
						</div>
					</div>
