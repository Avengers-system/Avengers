				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-10">
							<div class="row">
								<div class="col-xs-12">
								대학/학과/전공/학년 각각의 셀렉트박스와 학수번호/분반을 입력하여 검색가능한 검색버튼
								</div>
								<div class="col-xs-12">
								신청/과목번호/과목명/이수구분/강의실/담당교수/시간표/학점/수강제한인원/수강신청인원/강의계획서로 이루어진 개설강좌리스트
								수강신청가능기한에만 신청버튼이 활성화된다. 
								</div>
								<div class="col-xs-12">
								취소/학점/과목번호/과목명/이수구분/강의실/담당교수/시간표로 이루어진 신청내역리스트 
								본수강신청기간에만 이용가능하다.
								</div>
								<div class="col-xs-12">
								취소/신청/학점/과목번호/과목명/이수구분/강의실/담당교수/시간표로 이루어진 장바구니리스트
								사전수강신청기간 - 장바구니추가가능,장바구니삭제가능, 신청버튼 불가능
								본수강신청기간 - 신청버튼 가능,장바구니삭제가능, 장바구니추가불가능
								</div>
								<div class="col-xs-12">
							      현재 신청내역리스트에있는 강의들의 시간표를 pdf형식으로 보여주는 시간표보기 버튼 ,바로옆에 신청가능학점을 보여준다.
								</div>
							</div>
						</div>
					</div>
