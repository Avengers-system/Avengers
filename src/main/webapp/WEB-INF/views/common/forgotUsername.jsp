	...
	<form class="form-signin">
		<div class="panel periodic-login">
			...
			<div class="panel-body text-center">
				...
				<p class="atomic-mass">사용자 아이디 찾기</p>
			...
			<div class="text-center" style="padding: 5px;">
				<a href="${pageContext.request.contextPath}/login">메인화면으로 돌아가기</a><a href="${pageContext.request.contextPath}/forgotPassword"> | 비밀번호 찾기</a>
			</div>
		</div>
	</form>
</div>