	...
	<div class="panel panel-default">
		...
		<div class="panel-body" style="height: 580px; text-align: center;" >
			<form>
				...
				4.강의내용<br/>
				<textarea rows="10" cols="100" readonly>${detailLct.get('lct_cont')}</textarea><br/>
				<input type="button" onclick="location.href='${pageContext.request.contextPath}/student/classManage/lectureMain'" value="뒤로가기"/>
			</form>
		</div>
	</div>
</div>
