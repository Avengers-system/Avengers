...
<div class="col-md-10">
	<div class="panel panel-default">
		...
		<div class="panel-body" style="height: 580px; text-align: center;">
			...
			<form
				action="<%=request.getContextPath()%>/student/helpDesk/univStudSearch?board_title=
					...
					<li class="paginate_button previous disabled"
						id="datatables-example_previous"><c:if
							...
							<a href="javascript:fn_movePage(${pageVO.prevPageNo})"
								aria-controls="datatables-example" data-dt-idx="0" tabindex="0">
								이전페이지</a>
						</c:if></li>
					...
					<c:if test="${pageVO.pageNo != 0}">
						...
						<li class="paginate_button active"><c:if
								...
								<a href="javascript:fn_movePage(${pageVO.firstPageNo})"
									aria-controls="datatables-example" data-dt-idx="1" tabindex="0">[첫
									페이지]</a>
							</c:if></li>
						...
						<li class="paginate_button next disabled"
							id="datatables-example_next"><c:forEach var="i"
								begin="${pageVO.startPageNo}" end="${pageVO.endPageNo}" step="1">
								<c:choose>
						...
						<li class="paginate_button next disabled"
							id="datatables-example_next"><c:if
								...
								<a href="javascript:fn_movePage(${pageVO.nextPageNo})"
									aria-controls="datatables-example" data-dt-idx="2" tabindex="0">다음페이지</a>
							</c:if></li>
						...
						<li class="paginate_button next disabled"
							id="datatables-example_next"><c:if
								...
								<a href="javascript:fn_movePage(${pageVO.finalPageNo})"
									aria-controls="datatables-example" data-dt-idx="2" tabindex="0">마지막페이지</a>
							</c:if>
					</c:if>
					</li>
