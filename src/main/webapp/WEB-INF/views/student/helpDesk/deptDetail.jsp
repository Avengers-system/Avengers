...
<%--           날짜:<input type="text" name="board_date" value="${portalNoticeList.board_date}" readonly> --%>
          ...
          첨부파일다운:<a href="<%=request.getContextPath()%>/student/helpDesk/main/download?fileName=${deptNoticeList.board_af}&board_num=${board_num}" style="text-decoration: underline;">
