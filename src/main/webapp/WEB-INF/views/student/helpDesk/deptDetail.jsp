	...
	<c:when test="${not empty deptNoticeList}">
		<form name="updateDeptBoard" action="deptStudUpdate" method="post"
			...
			숫자:<input type="text" name="board_num"
				value="${deptNoticeList.board_num}" readonly><br> 제목:<input
				type="text" name="board_title" value="${deptNoticeList.board_title}"><br>
			...
			첨부파일다운:<a
				...
				style="text-decoration: underline;"> ${deptNoticeList.board_af}
			</a><br>
          ...
          첨부할파일:<input type="file" name="boardtoa"
			...
			<sec:authorize access="hasRole('ROLE_WSS')">
				...
				<a
					href="${pageContext.request.contextPath}/student/helpDesk/deptStudDelete?board_num=${deptNoticeList.board_num}"><input
