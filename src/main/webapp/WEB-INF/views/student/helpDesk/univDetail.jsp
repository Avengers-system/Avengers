      ...
      <form name="updateUnivBoard" action="univStudUpdate"
       method="post" enctype="multipart/form-data">
          ...
          작성자:<input type="text" name="board_writer" value="${univNoticeList.board_writer}" readonly><br>
            ...
            첨부파일다운:<a href="<%=request.getContextPath()%>/student/helpDesk/main/download?fileName=${univNoticeList.board_af}&board_num=${board_num}" style="text-decoration: underline;">
          ...
          첨부할파일:<input type="file" name="boardtoa" value="${univNoticeList.board_af}"><br></sec:authorize>
