			...
			<div class="col-xs-12" id="content">
				...
				<div class="row">
					...
					<div class="col-md-2" id="studentLeftSide">
						<input type="button" value="상담신청" onclick="location.href='consultGo.jsp'">
						<input type="button" value="상담내역" onclick="location.href='consultingList.jsp'">
					</div>
					<div class="col-md-10" id="studentRightSide">

						양식에 맞게 작성해서 상담을 신청한다.
						교수가 신청 가능한 날짜를 등록해놔서 그 해당 날짜에 학생이 신청 할 수 있다.
						선착순으로 신청이 마감되면 신청 할 수 없다.
						신청 양식에 맞게 신청한다.
