...
${portalNoticeList.board_af}&board_num=${board_num}"
          ...
          첨부할파일:<input type="file" name="boardtoa"
						...
						<sec:authorize access="hasRole('ROLE_ADMIN')">
							...
							<a
								href="portalProfDelete?board_num=${portalNoticeList.board_num}"><input
