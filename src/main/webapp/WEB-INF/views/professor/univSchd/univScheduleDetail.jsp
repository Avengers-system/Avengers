...
<script type="text/javascript">
	$(document).ready(function(){
		$("#scheduleMod").click(function(){
			...
			$.ajax({
				type : "post",
				url :"${myContextPath}/professor/univSchd/univScheduleUpdate",
				cache : false,
				data :  formData,
	...
	function onModSuccess(){
		location.href="${myContextPath}/professor/univSchd/univSchdedule";
	}
	$(document).ready(function(){
		$("#scheduleDel").click(function(){
			var formData = $("#scheduleDetail").serialize();
				$.ajax({
					type : "post",
					url :"${myContextPath}/professor/univSchd/univScheduleDelete",
					cache : false,
					data :  formData,
