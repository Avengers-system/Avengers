			...
			<div class="col-xs-12" id="content">
				...
				<div class="row">
					...
					<div class="col-md-2" id="studentLeftSide">
						<input type="button" value="증명서 발급" onclick="location.href='schoolRegister.jsp'">
						<input type="button" value="휴/복학 내역" onclick="location.href='schoolDetail.jsp'">
						<input type="button" value="휴/복학 신청" onclick="location.href='schoolApply.jsp'">
						<input type="button" value="자퇴 신청" onclick="location.href='schoolOff.jsp'">
					</div>
					<div class="col-md-10" id="studentRightSide">
						증명서 발급페이지
						증명서종류 / 발급매수 /선택 등등필요한 증명서를 선택할 수 있는 양식에 신청 버튼 하나 누르면 
						로그인한 사용자의 정보가 들어간 각종 증명서가 화면에 나타남
