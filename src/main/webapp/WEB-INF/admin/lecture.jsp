			...
			<div class="col-xs-12" id="content">
				...
				<div class="row">
					...
					<div class="col-md-2" id="adminLeftSide">
						<input type="button" value="강의목록" onclick="location.href='lecture.jsp'">
						<input type="button" value="강의등록" onclick="location.href='lectureInsert.jsp'">

					</div>

					<div class="col-md-10" id="adminRightSide">
						개설된 강의 목록을 볼 수 있다. 조회도 할수 있다.
						상세보기를 누르면 강의페이지로 들어간다.						
						
							<input type="button" value="상세보기" onclick="location.href='lectureDetail.jsp'">
					</div>
				</div>
