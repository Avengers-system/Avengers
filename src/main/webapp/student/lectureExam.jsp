			...
			<div class="col-xs-12" id="content">
				...
				<div class="row">
					...
					<div class="col-md-10" id="studentRightSide">
						...
						시험명(온라인시험인지 오프라인 시험인지 알 수 있다.) 시험을 볼 수 있는 기간(해당기간에만 시험을 응시 할 수 있다.)
							응시여부, 목록에서 시험을 응시할 수 있다.
						)
					<input type="button" value="시험 응시하기"onclick="location.href='lectureExamGo.jsp'">
