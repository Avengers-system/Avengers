			...
			<div class="col-xs-12" id="content">
				...
				<div class="row">
					...
					<div class="col-md-10" id="studentRightSide">
					 ...
					 사용자가 이강의에 출석한 현황을 볼 수 있는 캘린더로 되어있다.
					 캘린더에 출셕or 지각 결석 등등의 내용을 알 수 알 수 있고
					 이의신청을 누르면 교수가 알 수 있다.
					<input type="button" value="이의신청" onclick="location.href='lectureAttendGo.jsp'">
