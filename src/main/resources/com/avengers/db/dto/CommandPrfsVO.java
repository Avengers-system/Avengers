...
public class CommandPrfsVO {
   ...
   private MultipartFile prgs_pic;//증명사진
   ...
   public MultipartFile getPrgs_pic() {
	   return prgs_pic;
	}
   
   public void setPrgs_pic(MultipartFile prgs_pic) {
		this.prgs_pic = prgs_pic;
	}
   ...
   public PrfsVO toPrfsVO(){
	   ...
	   prfsVO.setPrgs_pic(prgs_pic.getName()); //사진빼구
	   return prfsVO;
   }
